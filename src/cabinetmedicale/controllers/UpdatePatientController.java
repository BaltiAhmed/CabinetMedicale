...
public class UpdatePatientController implements Initializable {
    ...
    int cid = LoginController.userId;
    int id;
        ...
        submit.setOnAction(event -> {
            ...
            if (!name.getText().equals("") || !email.getText().equals("") || !adresse.getText().equals("") || !tel.getText().equals("") || !date.getValue().toString().equals("")) {
                ...
                try {
                    ...
                    updatePatient(name.getText(), email.getText(), adresse.getText(), tel.getText(), date.getValue().toString());
    ...
    void updatePatient(String fullname, String email, String adresse, String tel, String date) throws SQLException {
        
        PatientService patientService = new PatientService();
        Patient patient = new Patient(id,cid, fullname, email, adresse, tel, date);
